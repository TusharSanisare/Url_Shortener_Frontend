      ...
      >
        <div className="flex-1 sm:space-y-1 max-w-full overflow-x-auto overflow-y-hidden ">
          <div className="text-slate-900 pb-1 sm:pb-0   flex items-center gap-2 ">
            <Link
              target="_"
              className="text-[18px]  font-[700] text-blue-900"
              to={
        ...
        <div className="flex  flex-1  sm:justify-end items-center gap-4">
          ...
          >
            <div className="flex cursor-pointer gap-1 items-center py-2  font-semibold shadow-md shadow-slate-200 px-6 rounded-md text-black border border-black ">
          ...
          <div
            ...
            className="flex cursor-pointer gap-1 items-center bg-blue-500 py-2 font-semibold shadow-md shadow-slate-200 px-6 rounded-md text-white "
          >
